...
class App(Tk):
    ...
    def widgets(self):
        ...
        #sign1 = Label(self.tab1, text="Ihor Tovstochub (ihor.tovstochub@ubisoft.com) ", font="Helvetica 7 bold")
        stat = Label(self.tab1, width="10", height="1", text="Inactive", font="Helvetica 11 bold", bd="20")

        spacer = Label(self.tab1, width="15",pady="20")
       ...
       # spacer.grid(row=0, column=2)
        ...
        def devs():
            messagebox.showinfo("Developers","Created by Ihor Tovstochub & Bucharest Networking Team\n Contact us:\n<ihor.tovstochub@ubisoft.com>\n<BUC-QC-Networking>")
        ...
        def bash():
            ...
            pd = "#!/bin/bash\ntc qdisc de dev {} root\ntc qdisc de dev {} root\nmodprobe sch_netem\ntc qdisc change dev {} root netem duplicate customu%\ntc qdisc change dev {} root netem duplicate customd%".format(req1, req2, req1, req2)
            pc = "#!/bin/bash\ntc qdisc de dev {} root\ntc qdisc de dev {} root\nmodprobe sch_netem\ntc qdisc change dev {} root netem corrupt customu%\ntc qdisc change dev {} root netem corrupt customd%".format(req1, req2, req1, req2)
            pr = "#!/bin/bash\ntc qdisc de dev {} root\ntc qdisc de dev {} root\nmodprobe sch_netem\ntc qdisc change dev {} root netem gap 5 delay 10ms".format(req1, req2, req1)
